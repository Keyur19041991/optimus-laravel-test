<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a class="text-white bg-gray-800 px-4 py-2" href="{{ route('category.create') }}">
        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <table class="border-collapse table-auto w-full text-sm">
                ...
                <tr>
                    ...
                    <th class="border-b  font-medium p-4 pl-8 pt-0 pb-3 text-slate-600 text-left">Parent Category</th>
                ...
                @forelse($categories as $category)
                    <tr>
                        <td class="border-b border-slate-100 p-4 pl-8 text-slate-500">{{ $category->title }}</td>
                        ...
                        <td class="border-b border-slate-100 w-[100px] text-center">
                            ...
                            <button class="bg-red-500 rounded-[50%] inline-flex p-2 px-2 text-white text-center"
                                    data-modal-toggle="delete_category_{{ $category->id }}_modal"><i
                                    class="fa fa-trash" size="18"></i></button>


                            <!-- Main modal -->
                            <div id="delete_category_{{ $category->id }}_modal" tabindex="-1" aria-hidden="true"
                                 class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    <!-- Modal content -->

                                    <form action="{{ route('category.destroy', $category->id) }}"
                                          id="form_delete_category_{{ $category->id }}" method="post">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                        ...
                                                        data-modal-toggle="delete_category_{{ $category->id }}_modal">
                                            ...
                                            <div
                                                ...
                                                <button data-modal-toggle="delete_category_{{ $category->id }}_modal" type="button"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center pt-5">No Categories Found</td>
                        </tr>
                    @endforelse
                </tbody>
